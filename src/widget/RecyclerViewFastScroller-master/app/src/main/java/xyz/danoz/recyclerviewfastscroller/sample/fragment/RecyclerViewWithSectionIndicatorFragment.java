...
//        recyclerView.setOnScrollListener(fastScroller.getOnScrollListener());//del by jackson
        recyclerView.addOnScrollListener(fastScroller.getOnScrollListener());//add by jackson
